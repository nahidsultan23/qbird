...
class RecoverAccountSuccess extends Component {
                    ...
                    <div className="container">
                        <div className="signup-content">
                            <div className="section-title">
                                <h2><span className="dot"></span>Password Recovery Successful!!</h2>
                            </div>
...
export default connect(mapStateToProps, { general })(RecoverAccountSuccess);
